!function(n) {
    ...
    function m() {
        for (var t; t = i.pop(); ) t._dirty && B(t);
    }
    function O(t, e) {
    ...
    function A(t, e, n, r, o) {
        ...
        if ("function" == typeof s) return function(t, e, n, r) {
            ...
            o && u && (!r || o._component) ? (M(o, s, 3, n, r), t = o.base) : (i && !c && (I(i), 
            t = a = null), o = D(e.nodeName, s, n), t && !o.nextBase && (o.nextBase = t, a = null), 
        ...
        return !b && f && 1 === f.length && "string" == typeof f[0] && null != l && void 0 !== l.splitText && null == l.nextSibling ? l.nodeValue != f[0] && (l.nodeValue = f[0]) : (f && f.length || null != l) && function(t, e, n, r, o) {
            ...
            if (0 !== m) for (var g = 0; g < m; g++) {
                var b = l[g], _ = b.__preactattr_, w = y && _ ? b._component ? b._component.__key : _.key : null;
                null != w ? (d++, f[w] = b) : (_ || (void 0 !== b.splitText ? !o || b.nodeValue.trim() : o)) && (p[v++] = b);
            }
            if (0 !== y) for (var g = 0; g < y; g++) {
                u = e[g], s = null;
                var w = u.key;
                if (null != w) d && void 0 !== f[w] && (s = f[w], f[w] = void 0, d--); else if (h < v) for (i = h; i < v; i++) if (void 0 !== p[i] && (x = a = p[i], 
                E = o, "string" == typeof (C = u) || "number" == typeof C ? void 0 !== x.splitText : "string" == typeof C.nodeName ? !x._componentConstructor && O(x, C.nodeName) : E || x._componentConstructor === C.nodeName)) {
    ...
    function L(t, e) {
        var n = t._component;
        n ? I(n) : (null != t.__preactattr_ && p(t.__preactattr_.ref, null), !1 !== e && null != t.__preactattr_ || j(t), 
        _(t));
    }
    function _(t) {
        for (t = t.lastChild; t; ) {
    ...
    function D(t, e, n) {
        ...
        r.render = x); o--; ) if (w[o].constructor === t) return r.nextBase = w[o].nextBase, 
        w.splice(o, 1), r;
        return r;
    }
    function x(t, e, n) {
    ...
    function M(t, e, n, r, o) {
        ...
        t.prevProps || (t.prevProps = t.props), t.props = e, t._disable = !1, 0 !== n && (1 !== n && !1 === S.syncComponentUpdates && t.base ? h(t) : B(t, 1, o)), 
        p(t.__ref, t));
    }
    function B(t, e, n, r) {
        if (!t._disable) {
            ...
            t._dirty = !1, !y) {
                ...
                var b, _, w = o && o.nodeName;
                if ("function" == typeof w) {
                    var x = P(o);
                    (i = v) && i.constructor === w && x.key == i.__key ? M(i, x, 1, s, !1) : (b = i, 
                    t._component = i = D(w, x, s), i.nextBase = i.nextBase || h, i._parentComponent = t, 
                    M(i, x, 0, s, !1), B(i, 1, n, !0)), _ = i.base;
    ...
    function I(t) {
        ...
        var n = t._component;
        n ? I(n) : e && (null != e.__preactattr_ && p(e.__preactattr_.ref, null), j(t.nextBase = e), 
        w.push(t), _(e)), p(t.__ref, null);
    }
    function C(t, e) {
    ...
    function ft(t) {
        ...
        return !ot || "string" !== i && "number" !== i || (t.attributes.ref = (n = o, (r = ot)._refProxies[n] || (r._refProxies[n] = function(t) {
            ...
            if (r.onchange && ("textarea" === e || "input" === e.toLowerCase() && !/^fil|che|rad/i.test(n.type))) {
                ...
                n[i] || (n[i] = xt([ n[i], n[r.onchange] ]), delete n[r.onchange]);
            }
        }(t), t;
    }
    function dt(t, e) {
    ...
    function _t(t) {
        ...
        return (t = vt({
            ...
            for (var n in e) e.hasOwnProperty(n) && (t[n] = xt(e[n].concat(t[n] || it), "getDefaultProps" === n || "getInitialState" === n || "getChildContext" === n));
        }(t, function(t) {
    ...
    function Ct(t, e) {
        Et.call(this, t, e), this.componentWillReceiveProps = xt([ Et, this.componentWillReceiveProps || "componentWillReceiveProps" ]), 
        this.render = xt([ Et, Ot, this.render || "render", St ]);
    }
    function Et(t, e) {
        if (t) {
            var n = t.children;
    ...
    function b(e, t) {
        ...
        if (t.singleton) {
            var u = p++;
            n = l || (l = y(t)), r = x.bind(null, n, u, !1), o = x.bind(null, n, u, !0);
    ...
    var w = function(t) {
        ...
        return p.createElement(f, {
            ...
            return t ? p.createElement(x, e) : p.createElement(C, e);
        });
    }), O = n(6);
    function S(t) {
    ...
    (t.exports = n(2)(!1)).push([ t.i, ".cart__alert {\n  background-color: rgba(255, 255, 255, 0.5);\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;\n  z-index: 999999; }\n  .cart__alert-hidden {\n    display: none; }\n  .cart__alert-shown {\n    display: table; }\n  .cart__alert-container {\n    display: table-cell;\n    vertical-align: middle; }\n", "" ]);
}, function(t, e, n) {
    var r = n(55);
    "string" == typeof r && (r = [ [ t.i, r, "" ] ]);
    var o = {
    ...
    (t.exports = n(2)(!1)).push([ t.i, ".cart__alert-wrapper {\n  display: block;\n  position: relative;\n  max-width: 85%;\n  margin: auto;\n  background-color: #ffffff;\n  border: 1px solid rgba(0, 0, 0, 0.06);\n  box-shadow: 0px 0px 100px rgba(0, 0, 0, 0.1); }\n  @media (min-width: 1200px) {\n    .cart__alert-wrapper {\n      max-width: 1000px; } }\n  @media (max-width: 768px) {\n    .cart__alert-wrapper {\n      max-width: 96%;\n      margin: none; } }\n\n.cart__alert-header, .cart__alert-footer {\n  display: block;\n  padding: 10px;\n  text-align: center;\n  box-sizing: content-box; }\n\n.cart__alert-header {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.06);\n  font-weight: bold; }\n\n.cart__alert-footer {\n  border-top: 1px solid rgba(0, 0, 0, 0.06); }\n\n.cart__alert-content {\n  padding: 15px; }\n  @media (max-width: 576px) {\n    .cart__alert-content {\n      padding: 5px; } }\n\n.cart__alert-close {\n  display: block;\n  position: absolute;\n  cursor: pointer;\n  right: 0px;\n  top: 0px;\n  width: 40px;\n  line-height: 40px;\n  text-align: center;\n  user-select: none; }\n", "" ]);
}, , , , , , , , , , function(t, e, n) {
    "use strict";
    n.r(e);
    var i = n(0), r = n(5), o = n(15);
    var a = n.n(o)()({
        productCode: null,
        productData: null,
        shown: !1,
        ...
        t.target === t.currentTarget && a.setState({
            productCode: null,
            productData: null,
            shown: !1,
            loading: !1
    ...
    document.addEventListener("click", function(t) {
        var e, n = t.target.getAttribute("data-product-code");
        n && (t.target.setAttribute("data-in-cart", "1"), e = n, a.setState({
            productCode: e,
            shown: !0,
            loading: !0
        }));
    });
    var u = n(6), s = n(19), p = (n(54), function(t) {
        var e = t.shown;
        return i.createElement("div", {
            className: "loader ".concat(e ? "shown" : "hidden")
        });
    }), f = function(t) {
        var e = t.condition, n = t.children;
        return e ? n : null;
    };
    n(56);
    function d(t) {
    ...
    var g = function() {
        return i.createElement("div", null, "Нет такого товара");
    }, l = function(t) {
        function l() {
            var t, e, n, r, o, i, a;
            !function(t, e) {
            ...
            return n = this, e = !(r = (t = m(l)).call.apply(t, [ this ].concat(u))) || "object" !== d(r) && "function" != typeof r ? y(n) : r, 
            o = y(y(e)), a = {
                data: null,
                fetching: !(i = "state"),
                error: !1
        ...
        return function(t, e) {
            ...
            value: function() {
                var r = this;
                this.props.code ? (this.setState(function(t) {
                    return {
                        fetching: !0
                    };
                }), Object(u.a)(this.props.code).then(function(t) {
                    var e = t.data, n = (e.response, {});
                    n.data = e ? e.response : null, n.fetching = !1, r.setState(function(t) {
                        return n;
                    });
                }).catch(function(t) {
            ...
            value: function(t) {
                this.props.code !== t.code && this.updateProductData();
            }
        }, {
            key: "render",
            value: function() {
                var t = this.props.code, e = this.state, n = e.data, r = e.fetching, o = null;
                return o = n ? i.createElement(s.a, {
                    data: n
                }) : null === t ? i.createElement(g, null) : null, i.createElement("div", {
                    className: "cart__alert-wrapper"
                }, i.createElement(f, {
                    condition: !r
                }, i.createElement("div", {
                    className: "cart__alert-header"
                }, "Добавлено в корзину")), i.createElement("div", {
                    className: "cart__alert-content"
                }, o || i.createElement(p, {
                    shown: !0
                })), i.createElement(f, {
                    condition: !r
                }, i.createElement("div", {
                    className: "cart__alert-footer"
                }, i.createElement("a", {
                    href: "/cart"
                }, "Перейти к оформлению заказа →"))), i.createElement("div", {
                    className: "cart__alert-close",
                    onClick: c
                }, "✖︎"));
            }
    ...
    var E = function(t) {
        function e() {
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
            }(this, e), w(this, x(e).apply(this, arguments));
        }
        var n, r, o;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function() {
                return i.createElement("div", {
                    className: "cart__alert-container",
                    onClick: c
                }, i.createElement(l, {
                    code: this.props.productCode
                }));
            }
        } ]) && _(n.prototype, r), o && _(n, o), e;
    }();
    function O(t) {
    ...
    var k = function(t) {
        function e() {
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
            }(this, e), N(this, P(e).apply(this, arguments));
        }
        var n, r, o;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function() {
                return i.createElement("div", {
                    className: "cart__alert cart__alert-".concat(this.props.shown ? "shown" : "hidden")
                }, this.props.shown ? i.createElement(E, {
                    productCode: this.props.productCode
                }) : null);
            }
        } ]) && S(n.prototype, r), o && S(n, o), e;
    }(), T = Object(r.connect)(function(t) {
        return {
            shown: t.shown,
            productCode: t.productCode
        };
    })(k);
    console.log("PRODUCTION"), Object(i.render)(i.createElement(r.Provider, {
        store: a
    }, i.createElement(T, null)), document.body.appendChild(document.createElement("div")));
} ]);